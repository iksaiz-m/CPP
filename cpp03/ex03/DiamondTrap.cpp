...
DiamondTrap::DiamondTrap() : ClapTrap("Default_clap_name"), ScavTrap("Default"), FragTrap("Default") // inherit from all classes in order
{
    std::cout << "Default DiamondTrap constructor called" << std::endl;
    DiamondTrap::_name = "Default"; // Giving him a name to make it different from the Claptrap name
